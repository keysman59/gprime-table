<template>
  <div class="dt-table">
   ...
   /> -->
    ...
    <div @click="$store.commit('MAP_CLOSE_SEARCH_TABLE')" class="dt-table__close">
...
export default {
  ...
  methods: {
    ...
    searchLayer (layer) {
      console.log('по идее должен почистить селект результ')
